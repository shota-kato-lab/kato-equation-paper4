...
\nopagebreak\noindent{\small\textbf{Figure 1: Bettencourt 22-indicator closure.} Forest plot of all 22 indicators (95\,\% CI) vs the zero-parameter ladder; hybrid closure: $H{=}\{2,3\}$ cluster anchors the bulk + continuous $\beta_{\pm}(\Heff)$ accommodates outliers, jointly 22/22 (Tier A 17 strict + Tier B $+5$ hybrid rows).\par}
